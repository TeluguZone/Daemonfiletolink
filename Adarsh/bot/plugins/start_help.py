        ...
        try:
            ...
            if user.status == "kicked":
             ...
             await StreamBot.send_photo(
                chat_id=m.chat.id,
                photo="https://graph.org/file/0ddc454be8d09540bb5d0.jpg https://graph.org/file/ce23b89250e011d02ed07.jpg",
            ...
            await b.send_message(
                chat_id=m.chat.id,
                text="<i>𝓢𝓸𝓶𝓮𝓽𝓱𝓲𝓷𝓰 𝔀𝓮𝓷𝓽 𝔀𝓻𝓸𝓷𝓰</i> <b> <a href='https://t.me/TeluguZone0'>CLICK HERE FOR SUPPORT </a></b>",
...
<b> I also support Channels, add me to you Channel and send any media files and see miracle✨ also send /list to know all commands""",
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("💁‍♂️ DEV", url="https://t.me/daemon990")],
                [InlineKeyboardButton("💥 Source Code", url="https://t.me/daemon990")]
            ]
        )
    )
